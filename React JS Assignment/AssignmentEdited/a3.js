    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <ul className="topnav">
                    <li><a className="active" href="#home" onClick={this.homeClick}>Home  </a></li>
                    <li className="right"><a href="#" onClick={this.loginClick}>Register </a></li>
                    <li className="right"><a href="#about" onClick={this.registerClick}>Login</a></li>
                </ul>
